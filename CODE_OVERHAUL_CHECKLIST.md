...
| Page File | Template File | API Files | Review Status |
|-----------|---------------|-----------|---------------|
| `ListEvents.php` | `templates/ListEvents.html` | `api/getevents.php` | [ ] |
| `ListEventsAll.php` | `templates/ListEventsAll.html` | `api/geteventsall.php` | [ ] |
| `OutingsPublic.php` | (inline) | (public event view) | [ ] |

**Priority Issues to Check:**
- [ ] Future events hidden appropriately
- [ ] Past events accessible for history
- [ ] Public page doesn't leak member info

### 3.2 Event Details & Management

| Page File | Template File | API Files | Review Status |
|-----------|---------------|-----------|---------------|
| `Event.php` | `templates/Event.html` | `api/getevent.php`, `api/amd_event.php` | [ ] |
| `Signups.php` | `templates/Signups.html` | `api/getsignups.php` | [ ] |
| `EventSignups.php` | `templates/EventSignups.html` | (signup management) | [ ] |

**Priority Issues to Check:**
- [ ] Event editing restricted to oe/sa
...
| Page File | Template File | API Files | Review Status |
|-----------|---------------|-----------|---------------|
| `EventPay.php` | `templates/EventPay.html` | `api/geteventpay.php`, `api/pay.php` | [ ] |
| `Approve.php` | `templates/Approve.html` | `api/getapprove.php`, `api/approve.php` | [ ] |
| `PPReturnPage2.php` | `templates/PPReturnPage2.html` | `api/ppupdate2.php` | [ ] |

**Priority Issues to Check:**
- [ ] Payment verification from PayPal
- [ ] No double-payment issues
- [ ] Approval restricted to appropriate users
...
| Page File | Template File | API Files | Review Status |
|-----------|---------------|-----------|---------------|
| `EventRosterSI.php` | `templates/EventRosterSI.html` | `api/geteventrostersi.php` | [ ] |
| (EventRoster) | `templates/EventRoster.html` | `api/geteventroster.php` | [ ] |

**Priority Issues to Check:**
- [ ] Roster access restricted to logged-in users
- [ ] Phone/email visible only to leaders
