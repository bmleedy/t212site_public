...
foreach ($updates as $update) {
  $user_id = isset($update['user_id']) ? intval($update['user_id']) : 0;
  $new_access = isset($update['user_access']) ? $update['user_access'] : '';
  $old_access = isset($update['old_access']) ? $update['old_access'] : '';
