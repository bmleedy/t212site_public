...
<form method="post" action="password_reset.php" name="password_reset_form">
    ...
    <input id="user_name" type="text" name="user_name" required />
		<div class='alert-box warning'>If you do not remember your username, anyone with T212 access can retreive for you by logging in to this site and locating your entry in the Directory. Your username is located directly below your email address.</div>
