...
class Login
{
    ...
    private $user_name = "";
		/**
		*  2 letter codes indicating access. Default is read all / edit your own profile
		*  sa = superadmin
		*  ue = edit all user details
		*  oe = add/mod/delete outings
		*  se = add/mod/delete signups
		*  ge = add/mod/del gear
		*  me = add/mod/del merit badge lists
		*/
    ...
    private $user_email = "";
    /**
     * @var string $user_first The user's first name
     */
    private $user_first = "";
    /**
	...
	$this->user_access = $_SESSION['user_access'];
        ...
        if (isset($_COOKIE['rememberme'])) {
            ...
            if (!empty($token) && hash_equals($expected_hash, $hash)) {
                ...
                if ($this->databaseConnection()) {
                    ...
                    $sth = $this->db_connection->prepare("SELECT user_id, user_name, user_email, family_id FROM users WHERE user_id = :user_id
                    ...
                    if (isset($result_row->user_id)) {
                        ...
                        $_SESSION['user_access'] = $result_row->user_access;
                        $_SESSION['user_type'] = $result_row->user_type;
                        $_SESSION['user_logged_in'] = 1;

                        // declare user id, set the login status to true
                        $this->user_id = $result_row->user_id;
                        $this->family_id = $result_row->family_id;
                        $this->user_name = $result_row->user_name;
                        $this->user_first = $result_row->user_first;
			$this->user_email = $result_row->user_email;
                        $this->user_access = $result_row->user_access;
    ...
    public function doLogout()
    {
        ...
        // todo: restore rememberme which seems more secure.
