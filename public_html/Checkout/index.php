...
&lt;/form&gt;</code></pre>
   ...
   <script type="text/javascript">
      ...
      // NOTE: These are PayPal sandbox test buyer accounts ONLY
      // These are NOT real credentials and are safe to keep in source control
      // They are used for testing PayPal integration in sandbox environment
      // Source: PayPal Developer Demo/Sample accounts
